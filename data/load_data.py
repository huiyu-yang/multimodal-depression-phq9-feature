...
class MMDataset(Dataset):
    def __init__(self, args, mode='train'):
        ...
        self.args = args
        DATA_MAP = {
            'cmdc': self.__init_cmdc,
        }
        DATA_MAP[args.datasetName]()

    def __init_cmdc(self):
        ...
        self.personal_feature = data[self.mode]['personal_feature'].astype(np.float32)  # modified by huiyu
        self.labels = {
    ...
    def __getitem__(self, index):
        sample = {
            ...
            'index': index,
            'id': self.ids[index],
            'personal_feature': torch.tensor(self.personal_feature[index], dtype=torch.float32),  # modified by huiyu
